...
namespace Library.Data
{
    public class LibraryDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ApplicationUser>().Property(u => u.UserName).HasMaxLength(ValidationConstants.UserNameMaxLength).IsRequired();

            builder.Entity<ApplicationUser>().Property(u => u.Email).HasMaxLength(ValidationConstants.EmailMaxLength).IsRequired();
